...
<html>
<head>
<title>TMS | Complaint Management System</title>
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">My Complaint History</h3>
...
$sql1= "SELECT * FROM complaints WHERE user_name='$uemail'";
